...
export function ProductForm({ preloadedValues, handleSuccess }) {
    ...
    return (
        <form className="border p-4 rounded w-75 mx-auto" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-group">
                {brands.length > 0 &&
                    <Controller
                        ...
                        render={({ onChange }) =>
                            <Select
                                defaultValue={brands.find(brand => brand.value === preloadedValues.brandId)}
                                options={brands}
                                onChange={onChange}
            ...
            <div className="form-group">
                <input className="form-control" type="number" min="1818" max="2021" step="1" name="modelYear" ref={register({
                    required: { value: true, message: "Required" },
                })}>
                </input>
            </div>
            ...
            <div className="form-group">
                <input className="form-control" type="number" step="any" name="listPrice" placeholder="List price" ref={register({
                    required: { value: true, message: "Required" },
                })} />
            </div>
